                ...
                <div class="card-body product-info">
                        ...
                        <div class="col-sm-7">
                            ...
                            @if($product->type === \App\Models\Product::TYPE_CROWDFUNDING)
                                <div class="crowdfunding-info">
                                    ...
                                    <div class="totle-amount"><span class="symbol">￥</span> {{ $product->crowdfunding->total_amount }}</div>
                                ...
                                @endif
                                    ...
                                    @elseif($product->type === \App\Models\Product::TYPE_SECKILL)
                                        @if(Auth::check())
                                            ...
                                            @elseif($product->seckill->is_atter_end)
                    ...
                    <div class="product-detail">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="nav-item"><a class="nav-link active" href="#product-detail-tab" aria-controls="product-detail-tab" role="tab" data-toggle="tab">商品详情</a></li>
                            <li role="presentation" class="nav-item"><a class="nav-link" href="#product-reviews-tab" aria-controls="product-reviews-tab" role="tab" data-toggle="tab">用户评价</a></li>
                        </ul>
...
//               把用户的收货地址用json的形式放入页面，复制给addresses变量
                ...
                $form.append('<div class="form-group">' +
                        ...
                        '<div class="col-sm-9"><input class="form-control" name="amount" value=' +
                        amount +
                        '>' +
                        '</div></div>'
                );
